...
const CLAUDE = "var(--primary)"; // theme accent instead of terracotta
const HILITE = "var(--ring)"; // the highlight the wave carries
...
function usePrefersReducedMotion() {
  // Subscribed as an external store instead of mirrored into state: no effect,
  // no cascading render, and the server snapshot keeps SSR honest.
