 ...
 */
// Theme-driven so the box inherits the app palette instead of Claude Code's
...
export function ClaudeHeader({
  ...
  return (
    <fieldset
      className={cn(
        "min-w-0 rounded-[6px] border px-3 pb-3.5 pt-1 font-mono text-[13px] leading-[1.5] text-foreground sm:px-4",
        className,
      )}
      style={{ borderColor: ACCENT }}
    >
      <legend className="max-w-full truncate px-2" style={{ color: ACCENT }}>
      ...
      <div className="grid min-w-0 gap-4 sm:grid-cols-[minmax(0,1fr)_1px_minmax(0,1.1fr)]">
        ...
        <div aria-hidden className="hidden bg-border sm:block" />
        ...
        <div className="min-w-0 space-y-1">
          ...
          <div className="my-1.5 h-px" style={{ background: ACCENT }} />
          <div className="font-semibold" style={{ color: ACCENT }}>
            What&apos;s new
          </div>
          {whatsNew.map((t) => (
