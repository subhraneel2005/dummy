...
/** Ultracode prompt-rule cycle, kept on-theme (no warm/amber hues). */
const ULTRACODE_RAINBOW =
  "linear-gradient(90deg,var(--primary),var(--ring),var(--muted-foreground),var(--ring),var(--primary))";
    ...
    <div className={cn("min-w-0 font-mono text-[13px] leading-[1.6]", className)}>
      ...
      >
        ...
        <input
          ...
          className={cn(
            "term-input min-w-0 flex-1 bg-transparent py-0.5 pl-[1ch] outline-none placeholder:text-muted-foreground",
            inputClassName,
          )}
