...
export const PromptInputButton = ({
  ...
  return (
    <Tooltip>
      {/* `render` makes the trigger render as the button itself. Wrapping the
          button in a default TooltipTrigger would nest a <button> inside a
          <button>, which is invalid HTML and fails hydration. */}
